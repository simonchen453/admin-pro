package com.adminpro.system.framework.batchjob.config;
...
import static com.adminpro.system.framework.common.constants.ConfigKeys.Quartz;
...
public class SchedulerConfig {
    ...
    private Properties buildQuartzProperties() throws IOException {
        ...
        prop.setProperty("org.quartz.dataSource.myDS.connectionProvider.class", 
                "com.adminpro.system.framework.batchjob.config.HikariConnectionProvider");
