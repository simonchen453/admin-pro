package com.adminpro.system.framework.common.constants;
...
public class WebConstants extends IConstants {
    ...
    public static String getServerAddress() {
        return ConfigHelper.getString(ConfigKeys.App.SERVER_ADDRESS);
    }
    ...
    public static String getUploadAvatarPath() {
        return ConfigHelper.getString(ConfigKeys.User.AVATAR_DIR, "/avatar/");
    }
