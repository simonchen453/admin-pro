package com.adminpro.system.framework.manager.factory;

import com.adminpro.framework.base.util.LoggerUtil;
import com.adminpro.system.framework.common.helper.WebHelper;
import com.adminpro.system.framework.common.helper.ip.AddressUtils;
    ...
    public static TimerTask recordLoginInfo(final String username, final String status, final String message, final Object... args) {
        ...
        return new TimerTask() {
            ...
            public void run() {
                ...
                s.append(LoggerUtil.getBlock(ip));
                s.append(address);
                s.append(LoggerUtil.getBlock(username));
                s.append(LoggerUtil.getBlock(status));
